...
class CleanersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cleaner" do
    assert_difference('Cleaner.count') do
      post cleaners_url, params: { cleaner: { employed: @cleaner.employed, first_name: @cleaner.first_name, last_name: @cleaner.last_name, quality_scope: @cleaner.quality_scope } }
    end
  ...
  test "should update cleaner" do
    patch cleaner_url(@cleaner), params: { cleaner: { employed: @cleaner.employed, first_name: @cleaner.first_name, last_name: @cleaner.last_name, quality_scope: @cleaner.quality_scope } }
